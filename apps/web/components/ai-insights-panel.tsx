          ...
          {!readOnly && (
            <>
              <button
                ...
                disabled={generating}
                className="inline-flex h-8 items-center gap-1.5 rounded-md bg-gradient-to-r from-indigo-500 to-purple-500 px-3 text-xs font-medium text-white hover:from-indigo-600 hover:to-purple-600 disabled:opacity-50"
              >
                {generating ? (
                  <>
