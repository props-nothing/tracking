...
export function MailchimpIcon({
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <path
        d="M18.86 11.56c.32-.46.52-1 .52-1.6 0-1.56-1.24-2.84-2.76-2.84-.26 0-.5.04-.74.1a4.68 4.68 0 0 0-3.88-2.1c-2.58 0-4.68 2.14-4.68 4.78 0 .34.04.66.1.98A3.96 3.96 0 0 0 4 14.8c0 2.18 1.76 3.96 3.92 3.96.42 0 .82-.08 1.2-.2A3.56 3.56 0 0 0 12 20.12a3.56 3.56 0 0 0 2.88-1.56c.38.12.78.2 1.2.2 2.16 0 3.92-1.78 3.92-3.96a3.96 3.96 0 0 0-1.14-3.24z"
        fill="#FFE01B"
      />
      <path
        d="M16.08 13c-.2 0-.36.04-.52.1a1.56 1.56 0 0 0-1.16-.52c-.5 0-.94.24-1.22.6a1.76 1.76 0 0 0-1.18-.46c-.58 0-1.08.28-1.4.7a1.56 1.56 0 0 0-1.96.28 1.56 1.56 0 0 0 .12 2.2c.28.24.62.38 1 .38.2 0 .38-.04.56-.12.28.36.72.6 1.22.6.42 0 .8-.16 1.08-.42.3.26.68.42 1.1.42.5 0 .94-.24 1.22-.6.16.04.34.08.52.08.86 0 1.56-.7 1.56-1.56S16.94 13 16.08 13z"
        fill="#1A1A1A"
        opacity="0.2"
      />
      <circle cx="10.2" cy="11.4" r="0.6" fill="#1A1A1A" />
      <circle cx="13.8" cy="11.4" r="0.6" fill="#1A1A1A" />
    </svg>
  );
}
