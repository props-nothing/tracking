    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Multi-step conversion funnels</p>
        </div>
        <Link
      ...
      {loading ? (
        ...
        <div className="rounded-lg border bg-card p-12 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Create a funnel to analyze multi-step conversion flows.</p>
          <Link
            href={`/dashboard/${siteId}/funnels/new`}
